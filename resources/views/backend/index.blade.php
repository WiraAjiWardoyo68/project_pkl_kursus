...
<script>
  $(function () {
    ...
    $.plot('#bar-chart', [bar_data], {
      ...
      colors: ['#3c8dbc'],
      xaxis : {
        ticks: [[1,'Jan'], [2,'Feb'], [3,'Mar'], [4,'Apr'], [5,'Mei'], [6,'Juni'], [7,'Juli'], [8,'Agus'], [9,'Sep'], [10,'Okto'], [11,'Nov'], [12,'Des']]
      }
    })
    /* END BAR CHART */
    ...
    var donutData = [
      {
        label: 'Laki-laki',
        data : {!! json_encode($male) !!},
        color: '#3c8dbc'
      },
      {
        label: 'Perempuan',
        data : {!! json_encode($female) !!},
        color: '#0073b7'
      }
    ]
